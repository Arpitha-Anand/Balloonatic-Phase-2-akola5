...
exports.signup = (req, res) => {
    let user = req.body;
    user = authenticate(req.body.first,req.body.last,req.body.password1,req.body.password2,req.body.email,req.body.address,req.body.city,req.body.state,req.body.zipcode,req.body.phone);
